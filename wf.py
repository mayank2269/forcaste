...
"""cityname="kerala"
data=requests.get("https://api.openweathermap.org/data/2.5/weather?q="+cityname+"&appid=7274a7e7e4840e99c6f6684722a3fccf").json()
print(data)"""

def dataget():
    city=cityname.get()
    data=requests.get("https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=7274a7e7e4840e99c6f6684722a3fccf").json()
...
com.place(x=50,y=145,height=35,width=500)

#states=
#comp=ttk.Combobox(win,text="latest weather app",values=lists,font=("Script typeface",15,"bold",))
#
# 
# comp.place(x=50,y=145,height=45,width=550)
...
done .place(x=570,y=145,height=35,width=100)
